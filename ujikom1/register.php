...
<body class="bg-gradient-primary">
            ...
            <div class="p-5">
              ...
              <form class="user" method="post" action="do_register.php">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="date" class="form-control form-control-user" name="tgl_lahir" placeholder="Tanggal Lahir">
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="password" class="form-control form-control-user" name="konpass" placeholder="Ulang Password">
                  </div>
                </div>

                <div class="form-group" id="pass_err">
                  <label class="control-label" style="color: red;">&nbsp;&nbsp;&nbsp;&nbsp;Password tidak sama</label>
                </div>
                <br>
                <p align="center">
                  <?php
  ...
  $(document).ready(function() {
    $('#pass_err').hide();
    $("input[name='konpass']").on('keyup change', function() {
